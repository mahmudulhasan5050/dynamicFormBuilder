        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Extension = table.Column<bool>(type: "bit", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AnswerConditions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConditionAnswer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MyFormId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerConditions_Participants_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnswerConditions_QuestionConditions_QuestionConditionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerConditions_ParticipantId",
                table: "AnswerConditions",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerConditions_QuestionConditionId",
                table: "AnswerConditions",
